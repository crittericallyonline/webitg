#include "global.h"
#include "LowLevelWindow_Null.h"
#include "RageLog.h"
#include "RageDisplay.h" // for REFRESH_DEFAULT
#include "StepMania.h"

LowLevelWindow_Null::LowLevelWindow_Null()
{
...
void LowLevelWindow_Null::SwapBuffers()
{
	// SDL_GL_SwapBuffers();
}

void LowLevelWindow_Null::Update(float fDeltaTime)
{
